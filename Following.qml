...
Rectangle {
    ...
    onStateChanged: if(popup.state == "Show") {followlist.clear(),Scripts.load_follows()}
    ...
    ListView {
        ...
        delegate: Item {
                    ...
                    MouseArea {
                        id:buttonclicker
                        anchors.fill:parent
                        onClicked: postslist.clear(),whichview = 1,searchstring = menuText,stream_reload.running = true,popup.state = "Hide";
